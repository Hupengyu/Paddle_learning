...
class BoxesConnector(object):
    ...
    def connect_boxes(self, if_txts_only=True):
        if if_txts_only:
            ...
            for result_block in np_result_blocks:
                ...
                new_result_txts.append(result_block[1])  # res,scores
            ...
            for result_block in np_result_blocks:
                ...
                new_result_rect = new_result_rect.astype(np.float32)  # 转为float32格式,后面要对应的！！！
                #
                new_result_boxes.append(new_result_rect)

                new_result_txts.append(result_block[1])

            return np.array(new_result_boxes), new_result_txts
